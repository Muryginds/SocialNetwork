...
public class RegisterRequestDTO {
  ...
  @Pattern(regexp = ValidationUtils.LETTERS_PATTERN, message = "last name should contain only alphabetic characters")
  ...
  @Pattern(regexp = ValidationUtils.EMAIL_PATTERN, message = "email should match form aaa@bbb.cc")
